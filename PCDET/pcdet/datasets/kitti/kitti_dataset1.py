...
if __name__ == '__main__':
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        create_kitti_infos(
            data_path=cfg.ROOT_DIR / 'data' / 'kitti1',
            save_path=cfg.ROOT_DIR / 'data' / 'kitti1'
        )
    else:
        A = KittiDataset(root_path='data/kitti1', class_names=cfg.CLASS_NAMES, split='train', training=True)
        import pdb
        ans = A[1]
